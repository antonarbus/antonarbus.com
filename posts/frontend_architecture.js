  ...
  body: (
    <>
      ...
      <ul>
        ...
        <li>it not an architecture, but simply tech oriented folder structure</li>
      ...
      <ul>
        <li>with this approach components like pages are isolated but rest of all not</li>
        <li>small components are interconnected</li>
      ...
      <ul>
        ...
        <li><code>module</code> is responsible for one task & ideally has all needed to do it</li>
        <li>Data flows vertically, code from lower layers can not import data from upper layers</li>
        <li>Other folders are permitted</li>
      </ul>
      ...
      <p><code>UI</code> has most generic UI blocks without any logic</p>
      ...
      <ul>
        <li><code>components</code> are a bit more complex components that may use blocks from <code>ui</code></li>
      ...
      <ul>
        <li><code>modules</code> are isolated independent blocks with its own responsibilities</li>
      ...
      <ul>
        ...
        <li>all logic is encapsulated inside a module and data to the outside should go via <code>index</code> file <i>public api</i></li>
      </ul>
      ...
      <p><code>pages</code> are like <code>modules</code> on upper level</p>

      <LazyImg path='/imgs/frontend-architecture/02 07 pages.png' width='400px'/>

      <p><code>page</code> can have own components, apis, helpers, etc...</p>

      <LazyImg path='/imgs/frontend-architecture/02 08 page inside.png' width='600px'/>

      <ul>
        <li><code>page</code> as thin as possible</li>
        <li>ideally it should be a list of modules and components</li>
        <li>as much business logic, helpers, states etc... should be extracted into modules if possible</li>
      ...
      <ul>
        <li>just to have <code>pages</code>, <code>modules</code>, <code>components</code> & <code>ui</code> is not enough in real project</li>
      ...
      <ul>
        <li>+ isolation on module levels with public apis</li>
        ...
        <li>- where to keep business related entities like data, types and components for a product, an article, a user</li>
      ...
      <ul>
        ...
        <li>❗️Code on one layer can only interact with code from the layers below</li>
      </ul>
      ...
      <ul>
        ...
        <li>Can contain interactive UI elements, internal state and API calls that enable value-producing actions.</li>
      </ul>
      ...
      <ul>
        ...
        <li>❗️It might be hard to decide what goes into Entities and Features. Do not worry. Just put all logic into Widgets layer. You will feel later if it should be split into Entities and Features.</li>
      </ul>
      ...
      <ul>
        ...
        <li>❗️No business and minimum other logic here.</li>
      </ul>
      ...
      <ul>
        ...
        <li>it is a module in modular design</li>
      ...
      <p>A slice consists of segments to separate code by its technical nature, common segments, ❗️but not necessarily are</p>
