  ...
  body: (
    <>
      ...
      <ul>
        ...
        <li>
          <strong>Staging Area / Index</strong> An intermediate area where changes are placed before
          committing. You "add" files to the index with <code>git add</code>.
        </li>
        <li>
        ...
        <li>
          <strong>Pull</strong> <code>fetch</code> + <code>merge</code> updates your current branch
        ...
        <li>
          <strong>Tag</strong> A named reference to a specific commit, often used to mark releases.
        </li>
        <li>
